...
model.load_state_dict(torch.load('./model_ckpts/med_shape_e.pth', map_location=device)['model_state_dict'])
...
import pickle
import pandas as pd
test_uids = pickle.load(open('/home/estudiante/dataset/test_organs.pickle', 'rb'))
captions = pd.read_csv('/home/estudiante/dataset/organs_selected_complete.csv', header=None)
